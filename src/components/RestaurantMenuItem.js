  ...
  return (
    <div className="px-20 flex mt-5 pt-2 mx-auto pb-5">
      <div className="flex mx-auto bt-2 px-100 text-sm">
        <div className="pr-30">
        <img className="w-60 h-40" src={menuItem["image-src"]} alt="List Items" />
        </div>
        <div className="w-[40rem] pt-0">
          ...
          <button onClick={() => dispatch(add(menuItem))} className="border px-5 py-2 mt-4 hover:bg-green-600 hover:text-white rounded cursor-pointer mb-2">ADD</button>
        </div>
      </div>
      <hr />
    </div>
